...
from helper.mocap import MocapDM
from helper.mujoco_interface import MujocoInterface

from gym.envs.mujoco import mujoco_env
from gym import utils

from helper.tiny.config import Config
from pyquaternion import Quaternion

from helper.transformations import quaternion_from_euler
...
class DPEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def calc_config_reward(self):
        ...
        target_config = self.mocap.data_config[self.idx_curr] # to exclude root joint
