...
human = "/home/daniel/Desktop/subject_scaled_run_converted/subject_scaled_run_converted.xml"
...
with open("/home/daniel/Desktop/DeepMimic_Research/helper/motions/humanoid3d_walk.txt", 'r') as fin:
    data = json.load(fin)
